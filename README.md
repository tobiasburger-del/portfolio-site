# Tobias Burger Portfolio

A personal portfolio website built incrementally as part of a web development course. The project grows week by week — starting from static HTML/CSS and evolving into a full-stack, database-driven, deployed application.
